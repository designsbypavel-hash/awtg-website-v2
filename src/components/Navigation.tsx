    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'SCAP', desc: 'Spectrum and capacity analysis platform for network planning', href: '/connectivity/scap' },
          { label: 'iDAMS', desc: 'Intelligent data and asset management system', href: '/connectivity/idams' },
        ],
      },
      {
        heading: 'Industries',
