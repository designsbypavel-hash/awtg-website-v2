        ...
        <div className="grid lg:grid-cols-[1.08fr_0.92fr]">
          <div className="relative overflow-hidden bg-[#f8fafc] px-7 py-8 sm:px-10 sm:py-10 lg:px-12 lg:py-12">
            ...
            <div className="relative">
              ...
              <p className="max-w-xl text-base font-normal leading-[1.7] text-[#0a1628]/60">
                {description}
              </p>
          ...
          <div className="relative bg-white px-7 py-8 sm:px-10 sm:py-10 lg:px-12 lg:py-12">
            ...
            <form className="mt-8 space-y-5" onSubmit={(event) => event.preventDefault()}>
              ...
              <label className="block">
                ...
                <select className="h-[52px] w-full rounded-[7px] border border-gray-300 bg-white px-4 text-sm text-[#0a1628]/60 outline-none transition-colors focus:border-[#228DC1] focus:ring-4 focus:ring-[#228DC1]/10">
