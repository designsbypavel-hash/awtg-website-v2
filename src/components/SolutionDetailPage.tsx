        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-12 grid lg:grid-cols-[1fr_0.8fr] gap-16 items-center">
          ...
          <div className="border border-gray-100 p-7 bg-white/[0.03]">
            ...
            <div className="space-y-3">
              {related.map((link) => (
                <Link key={link.href} to={link.href} className="flex items-center justify-between border-b border-gray-100 pb-3 text-[#0a1628]/70 hover:text-[#228DC1] font-normal text-[15px] transition-colors">
                  {link.label}
