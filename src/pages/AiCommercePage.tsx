    ...
    items: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1603714228681-b399854b8f80?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
      },
      {
        icon: faCartShopping,
        ...
        image: 'https://images.unsplash.com/photo-1753161028509-095944dd2ee7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
      },
      {
        icon: faChartLine,
