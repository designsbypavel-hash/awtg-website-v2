...
const sections = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <Para>
          Our legitimate interests are to render and improve our Services in an effective, safe and harmless manner. We want to provide everyone with a fair and balanced experience when using our Services. </Para>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <Para>
          We collect Personal Data and other information that you voluntarily provide. It is entirely your decision to provide the requested information. However, your use of certain Services is possible only if you provide required information, e.g. while creating an Account. </Para>
        <SubHeading>Account Data</SubHeading>
        <Para>
          When setting up an Account, you may be asked to provide Personal Data including, but not limited to, your name, email address and telephone number. </Para>
        ...
        <Para>
          We also collect content and information that other people provide when they use our Services, including information about you, such as when they share a photo of you, send a message to you, or import your contact information. </Para>
        <SubHeading>Your connections</SubHeading>
        <Para>
          We collect information about the people and groups you are connected to using AWTG Services and how you interact with them. We also collect contact information you provide if you upload such information (such as an address book) from a device. </Para>
        <SubHeading>Information from websites and apps that use our Services</SubHeading>
        <Para>
          We collect information when you visit or use third party websites and apps that use our Services (like when they allow sharing to AWTG Service or AWTG Software). This includes information about the websites and apps you visit, your use of our Services on those websites and apps, as well as information the developer or publisher of the app or website provides to you or us. </Para>
        <SubHeading>Information from third party partners</SubHeading>
        <Para>
          We receive information about you and your activities on and off AWTG from third party partners, such as information from a partner when we jointly offer services. </Para>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <Para>
          We indirectly collect a variety of information through your interaction with and use of our AWTG products, AWTG Software and other Services. </Para>
        <Para>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <Para>
          We need to process your Personal Data in order to perform the contract with you according to Article 6(1)(b) of the GDPR. As a user, we will use your Personal Data, unless otherwise prohibited by law, for the following purposes: </Para>
        <Bullets items={[
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <Para>
          You may, of course, decline to submit Personal Information through the AWTG Software or the AWTG Service, in which case AWTG may not be able to provide certain services to you. If you do not agree with our Privacy Policy or Terms of Service, please delete your account, uninstall the AWTG mobile application and discontinue use of the AWTG Service. </Para>
        <SubHeading>Information we retain</SubHeading>
        <Para>
          Upon expiry of the suspension period we will delete all Personal Data about you, except for the data that are required for our compliance with the requirements of applicable laws (e.g. tax and accounting requirements) or for our detection, investigation and prevention of cheating. We will also retain anonymous information after your Account has been closed. Information you have shared with others will remain visible after you closed your account or deleted the information from your own profile or mailbox, and we do not control data that other users copied out of our Services. </Para>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <Para>
          We may collect and release Personal Data and/or non personally identifiable information if required to do so by law, or in the good faith belief that such action is necessary to comply with national law, international law or respond to a court order, subpoena, or search warrant or equivalent, or where in our reasonable belief, an individual's physical safety may be at risk or threatened. </Para>
        <Para>
          AWTG also reserves the right to disclose Personally Identifiable Information and/or non personally identifiable information that AWTG believes, in good faith, is appropriate or necessary to enforce our Terms of Service, take precautions against liability, to investigate and defend itself against any third party claims or allegations, to assist government enforcement agencies, to protect the security or integrity of AWTG Services or our servers, and to protect the rights, property, or personal safety of AWTG, our users or others. </Para>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <Para>
          We may change this Policy from time to time for various reasons, such as legal and regulatory changes, changes in industry practices and technological developments that need to be reflected. </Para>
        <Para>
          Please revisit this page to stay aware of any changes. Your continued use of the AWTG Site and AWTG Service constitutes your agreement to this Privacy Policy and any amendments. For information about how to contact AWTG, please visit our contact page. </Para>
      </div>
    ),
  },
]
    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          ...
          <p className="type-label text-[#0a1628]/60 mb-6">Effective April 2020</p>
          <p className="text-[#0a1628]/60 text-base max-w-2xl font-normal leading-[1.75]">
            AWTG Limited recognises that you, its users, customers and visitors, want to know how we protect your privacy. This Privacy Policy helps you make an informed decision about whether to use or continue using the AWTG Service and/or AWTG Software. </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-8 lg:px-12 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            <p className="type-label text-[#1a7aab] mb-3">Privacy Enquiries</p>
            ...
            <p className="text-[#0a1628]/60 text-sm mt-3 max-w-xl leading-[1.75]">
              Contact AWTG at{' '}
              <a href="mailto:info@awtg.co.uk" className="text-[#1a7aab] hover:underline">info@awtg.co.uk</a>{' '}
              or write to us at 8 Canham Mews, Canham Road, London, W3 7SR, United Kingdom. </p>
          </div>
          <Link
            to="/contact"
