  ...
  'tot-service-assurance': {
    ...
    content: [
      ...
      { type: "bullets", items: [
        ...
        "IoT service creation on existing 3G infrastructure, with no new network investment required",
  ...
  'data-offloading-wifi': {
    ...
    content: [
      ...
      { type: "bullets", items: [
        ...
        "Operator-managed offload required authentication infrastructure beyond what was available in most public WiFi deployments",
  ...
  'rich-communications-suite': {
    ...
    content: [
      ...
      { type: "bullets", items: [
        ...
        "A fragmented approach would not achieve the scale needed to compete with global OTT platforms",
  ...
  'small-cell-site-acquisition': {
    ...
    content: [
      ...
      { type: "stat-row", stats: [
        ...
        { value: "Future", label: "Offload infrastructure built today serves 4G demand" },
      ]},
