    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          ...
          >
            Why the Website<br />
            Looks the Way It Does </h1>
          <p className="text-[#0a1628]/60 text-lg max-w-2xl font-normal leading-relaxed">
            Every design decision on this website connects to a clear rationale, rooted in three reference points: Harvey AI, Nokia, and Ericsson. This document explains the thinking behind each choice. </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-8 lg:px-12 text-center">
          ...
          >
            "AWTG is a company serious enough that it doesn't need to perform seriousness." </blockquote>
          <p className="text-[#0a1628]/60 mt-6 text-sm font-normal max-w-2xl mx-auto leading-relaxed">
            Harvey doesn't use colour to signal prestige. The restraint is the prestige. Nokia doesn't soften its headlines. The boldness is the confidence. Ericsson doesn't illustrate its claims. The data is the proof. </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-[#0a1628]/60 text-sm font-normal">
              Prepared by the design team. Inspired by Harvey AI, Nokia, and Ericsson. </p>
          </div>
          <a
            href="/"
