      ...
      <section className="pt-32 pb-20 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          ...
          <p className="text-[#0a1628]/60 text-lg max-w-2xl font-normal leading-relaxed">
            Omnichannel connectivity and AI solutions for retailers, driving operational efficiency, customer insight and sales performance across physical and digital store environments. </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-8 lg:px-12">
          <h2 className="font-heading text-[#0a1628] mb-4">
            Solutions for Retail </h2>
          <p className="text-[#0a1628]/60 mb-14 max-w-2xl font-normal text-[16px] leading-[1.7]">
            AWTG helps retailers compete in a connected world, deploying the wireless infrastructure and AI analytics that improve margins, customer experience and operational resilience. </p>
