            ...
            <div className="grid gap-4">
              ...
              <div className="grid lg:grid-cols-[112px_minmax(0,1fr)] gap-3 lg:items-start">
                <div className="flex items-center gap-3 pt-2">
                  ...
                  <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[#0a1628]/45">Topics</p>
                </div>
                <div className="flex flex-wrap items-center gap-2" role="toolbar" aria-label="Whitepaper topic filters">
                  {topics.map((topic) => (
                    <button
                      key={topic}
                      type="button"
